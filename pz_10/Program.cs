...
namespace pz_10
{
    class Program
    {
        ...
        {
            string[][] cstrs = new string[5][];
            string[] last_elems_of_cstrs = new string[5];
            string[] max_strs = new string[5];
            string[] max_str_of_length = new string[5];
            Random rnd = new Random();

            for (int i = 0; i < 5; i++)
            {

                cstrs[i] = new string[rnd.Next(3, 20)];
